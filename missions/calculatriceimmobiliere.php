  ...
  <section class="service_section layout_padding" id="maquette-apple-section">
    ...
    <div class="container ">
      <div class="row carreau">
              <img src="../images/calculatriceimmobiliere.png" alt="netflix" >
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="price_container ">
        <div class="box">
          ...
          <div class="btn-box">
            <a href="https://quentin3749.github.io/calculatrice-immobiliere/" target="_blank">
              résultat final
            </a>
          </div>
        </div>
        <div class="box">
          ...
          <div class="btn-box">
            <a href="https://github.com/Quentin3749/calculatrice-immobiliere" target="_blank">
              visuel du code
            </a>
          </div>
        </div>
