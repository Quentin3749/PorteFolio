  ...
  <section class="service_section layout_padding" id="maquette-apple-section">
    ...
    <div class="container ">
      <div class="row carreau">
              <img src="../images/calculatricepourboire.png" alt="calculatrice pourboire" >
      </div>
    </div>
  </section>
  ...
  <section class="price_section layout_padding">
    <div class="container">
      ...
      <div class="cadre">
                ...
                <p class="centered-text">- Maîtrise de javascript </p>
      ...
      <div class="price_container ">
        <div class="box">
          ...
          <div class="btn-box">
            <a href="https://quentin3749.github.io/calculette_pourboire/" target="_blank">
              résultat final
            </a>
          </div>
        </div>
        <div class="box">
          ...
          <div class="btn-box">
            <a href="https://github.com/Quentin3749/calculette_pourboire" target="_blank">
              visuel du code
            </a>
          </div>
        </div>
