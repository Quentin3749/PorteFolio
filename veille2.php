...
?>
    ...
    <section class="service_section layout_padding ">
      ...
      <div class="container container1 slider_section">
       ...
       <p><img src="images/logo_freshrss.png">   <img src="images/logo_feedly.png"> <img src="images/logo_daily.dev.jpg"></p>
       <h3>- Mes sujets de veille :</h3>
                <ul>
                    
                    
                <li>Les algorithmes d'intelligence artificielle et d'apprentissage automatique : évolutions des algorithmes de machine learning, nouveaux modèles de deep learning et leurs applications pratiques</li>
                    <li>La programmation robotique : évolution des langages dans le domaine de la robotique industrielle et collaborative</li>
                    <li>La cybersécurité : veille sur les nouvelles cybermenaces, les solutions de protection émergentes, et l'évolution des techniques de défense contre les ransomwares et autres formes de cyberattaques</li>
                </ul>
           </div>
